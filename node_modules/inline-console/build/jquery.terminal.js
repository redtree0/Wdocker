...
(function ($, undefined) {
            ...
            if ((typeof object === 'undefined' ? 'undefined' : (0, _typeof3.default)(object)) === 'object') {
                if ($.isArray(object)) {
                    ...
                    for (var key in object) {
                        ...
                        } else if ((0, _typeof3.default)(object[key]) === 'object') {
    ...
    function wls(n, v) {
        ...
        if (typeof n === 'string' && typeof v === 'string') {
            localStorage[n] = v;
            return true;
        } else if ((typeof n === 'undefined' ? 'undefined' : (0, _typeof3.default)(n)) === 'object' && typeof v === 'undefined') {
            for (c in n) {
    ...
    */
    ...
    // -----------------------------------------------------------------------
    function Stack(init) {
        var _data = init instanceof Array ? init : init ? [init] : [];
        $.extend(this, {
            data: function data() {
                return _data;
            },
    ...
    function History(name, size, memory) {
        ...
        if (memory) {
            ...
            _data2 = _data2 ? $.parseJSON(_data2) : [];
        }
            ...
            append: function append(item) {
                if (_enabled) {
                    if (_data2[_data2.length - 1] !== item) {
                        ...
                        pos = _data2.length - 1;
                        if (!memory) {
                            $.Storage.set(storage_key, (0, _stringify2.default)(_data2));
                        }
                    }
                }
            },
    ...
    $.fn.cmd = function (options) {
        ...
        var default_keymap = {
            'ALT+D': function ALTD() {
                self.set(command.slice(0, _position) + command.slice(_position).replace(/ *[^ ]+ *(?= )|[^ ]+$/, ''), true);
                // chrome jump to address bar
                return false;
            },
            'ENTER': function ENTER() {
                if (_history && command && !_mask && $.isFunction(options.historyFilter) && options.historyFilter(command) || options.historyFilter instanceof RegExp && command.match(options.historyFilter) || !options.historyFilter) {
            ...
            'CTRL+K': function CTRLK() {
                _kill_text = self['delete'](command.length - _position);
                text_to_clipboard(self, _kill_text);
                return false;
            },
        ...
        function next_history() {
            self.set(_history.end() ? last_command : _history.next());
            return false;
        }
        function left() {
            if (_position > 0) {
        ...
        var redraw = function () {
            ...
            return function () {
                var string;
                switch (typeof _mask === 'undefined' ? 'undefined' : (0, _typeof3.default)(_mask)) {
                    case 'boolean':
                        string = _mask ? command.replace(/./g, '*') : command;
                        break;
                    case 'string':
                        string = command.replace(/./g, _mask);
                        break;
                }
                var i;
                ...
                if (string.length > num_chars - prompt_len - 1 || string.match(/\n/)) {
                    ...
                    if (first_len === 0 && array.length === 1) {
                        ...
                        draw_cursor_line(array[0], _position);
                        ...
                        if (_position < first_len) {
                            ...
                            var from_last = string.length - _position - tabs_rm;
                            ...
                            if (from_last <= last_len) {
                                ...
                                draw_cursor_line(array[1], _position - first_len - 1);
                                str = format(array[2]);
                    ...
                    draw_cursor_line(string, _position);
                }
            };
        }();
        // ---------------------------------------------------------------------
        ...
        var draw_prompt = function () {
            ...
            return function () {
                switch (typeof _prompt === 'undefined' ? 'undefined' : (0, _typeof3.default)(_prompt)) {
                    case 'string':
                        set(_prompt);
                        break;
                    case 'function':
        ...
        $.extend(self, {
            name: function name(string) {
                if (string !== undefined) {
                    ...
                    _history = new History(string, historySize, options.history === 'memory');
            ...
            'delete': function _delete(n, stay) {
                ...
                if (n === 0) {
                    ...
                    if (_position > 0) {
                        ...
                        command = command.slice(0, _position + n) + command.slice(_position, command.length);
                        if (!stay) {
                            self.position(_position + n);
                        }
                        fire_change_command();
                    }
                } else if (command !== '' && _position < command.length) {
                    removed = command.slice(_position).slice(0, n);
                    command = command.slice(0, _position) + command.slice(_position + n, command.length);
                    fire_change_command();
                }
                redraw();
                fix_textarea();
            ...
            keymap: function keymap(new_keymap) {
                if (typeof new_keymap === 'undefined') {
                    return _keymap;
                } else {
                    _keymap = $.extend({}, default_keymap, $.omap(new_keymap || {}, function (key, fn) {
                        return function (e) {
            ...
            insert: function insert(string, stay) {
                if (_position === command.length) {
                    ...
                    command = command.slice(0, _position) + string + command.slice(_position);
                }
                if (!stay) {
            ...
            position: function position(n, relative) {
                if (typeof n === 'number') {
                    ...
                    if ($.isFunction(options.onPositionChange)) {
                        options.onPositionChange(_position);
                    }
                    redraw();
                    fix_textarea();
                    return self;
        ...
        function keydown_event(e) {
            ...
            if (enabled) {
                ...
                } else if ($.isFunction(_keymap[key])) {
                    result = _keymap[key]();
                    if (result === true) {
                        return;
                    }
        ...
        function input() {
            ...
            if ((no_keypress || dead_key) && !skip_insert && (single_key || no_key) && !backspace) {
                var pos = _position;
                var val = clip.val();
                if (val !== '') {
                    if (reverse_search) {
    ...
    $.terminal = {
        ...
        split_equal: function split_equal(str, length, words) {
            ...
            function is_space() {
                return line.substring(j - 6, j) === '&nbsp;' || line.substring(j - 1, j) === ' ';
            }
            ...
            for (var i = 0, len = array.length; i < len; ++i) {
                ...
                for (var j = 0, jlen = line.length; j < jlen; ++j) {
                    ...
                    if ((count === length || j === jlen - 1) && (formatting && in_text || !formatting)) {
        ...
        parse_arguments: function parse_arguments(string) {
            return $.map(string.match(command_re) || [], function (arg) {
                ...
                } else if (arg[0] === "'" && arg[arg.length - 1] === "'" && arg.length > 1) {
    ...
    function is_key_native() {
        ...
        var get = (0, _getOwnPropertyDescriptor2.default)(proto, 'key').get;
    ...
    $.jrpc = function (url, method, params, success, error) {
        ...
        function validJSONRPC(response) {
            return typeof response.id === 'number' && typeof response.result !== 'undefined' || options.method === 'system.describe' && response.name === 'DemoService' && typeof response.id !== 'undefined' && response.procs instanceof Array;
        }
        ...
        return $.ajax({
            ...
            beforeSend: function beforeSend(jxhr, settings) {
                ...
                settings.data = (0, _stringify2.default)(request);
            },
    ...
    */
    ...
    var copyright = 'Copyright (c) 2011-2017 Jakub Jankiewicz <http://jcubic' + '.pl>';
    ...
    // :: Terminal Signatures
    // -----------------------------------------------------------------------
    var signatures = [['jQuery Terminal', '(c) 2011-2017 jcubic'], [name_ver, copyright.replace(/^Copyright | *<.*>/g, '')], [name_ver, copyright.replace(/^Copyright /, '')], ['      _______                 ________                        __', '     / / _  /_ ____________ _/__  ___/______________  _____  / /', ' __ / / // / // / _  / _/ // / / / _  / _/     / /  \\/ / _ \\/ /', '/  / / // / // / ___/ // // / / / ___/ // / / / / /\\  / // / /__', '\\___/____ \\\\__/____/_/ \\__ / /_/____/_//_/_/_/ /_/  \\/\\__\\_\\___/', '         \\/          /____/                                   '.replace(reg, ' ') + version_string, copyright], ['      __ _____                     ________                            ' + '  __', '     / // _  /__ __ _____ ___ __ _/__  ___/__ ___ ______ __ __  __ ___ ' + ' / /', ' __ / // // // // // _  // _// // / / // _  // _//     // //  \\/ // _ ' + '\\/ /', '/  / // // // // // ___// / / // / / // ___// / / / / // // /\\  // // ' + '/ /__', '\\___//____ \\\\___//____//_/ _\\_  / /_//____//_/ /_/ /_//_//_/ /_/ \\' + '__\\_\\___/', ('          \\/              /____/                                      ' + '    ').replace(reg, '') + version_string, copyright]];
    // -----------------------------------------------------------------------
    // :: Default options
    // -----------------------------------------------------------------------
    $.terminal.defaults = {
    ...
    $.fn.terminal = function (init_interpreter, options) {
        ...
        function get_processed_command(command) {
            if ($.isFunction(_settings.processArguments)) {
        ...
        function display_object(object) {
            if (typeof object === 'string') {
                ...
                self.echo((0, _stringify2.default)(object));
            } else {
                self.echo(object);
            }
        }
        ...
        function display_json_rpc_error(error) {
            if ($.isFunction(_settings.onRPCError)) {
            ...
            var interpreter = function interpreter(method, params) {
                ...
                $.jrpc({
                    ...
                    request: function request(jxhr, _request) {
                        try {
                            _settings.request.apply(self, jxhr, _request, self);
                        } catch (e) {
                    ...
                    response: function response(jxhr, _response) {
                        try {
                            _settings.response.apply(self, jxhr, _response, self);
                        } catch (e) {
                            display_exception(e, 'USER');
                        }
                    },
                    success: function success(json) {
                        ...
                        } else if ($.isFunction(_settings.processRPCResponse)) {
        ...
        function make_object_interpreter(object, arity, login, fallback) {
            ...
            return function (user_command, terminal) {
                ...
                try {
                    ...
                    // exception can be thrown on invalid regex
                    if ($.isFunction(_settings.exception)) {
                ...
                } else if ($.isFunction(_settings.onCommandNotFound)) {
        ...
        function ajax_error(xhr, status, error) {
            ...
            if ($.isFunction(_settings.onAjaxError)) {
            ...
            if (type === 'array') {
                ...
                (function recur(interpreters, success) {
                    if (interpreters.length) {
                        ...
                        if (type === 'string') {
                            self.pause(_settings.softPause);
                            if (_settings.ignoreSystemDescribe) {
                                if (++rpc_count === 1) {
                    ...
                    finalize({
                        interpreter: make_object_interpreter(object, false, login, fn_interpreter.bind(self)),
                        completion: (0, _keys2.default)(object)
                    });
                });
            } else if (type === 'string') {
                if (_settings.ignoreSystemDescribe) {
                    ...
                    make_json_rpc_object(user_intrp, login, function (object) {
                        if (object) {
                            ...
                            result.completion = (0, _keys2.default)(object);
                        } else {
                ...
                finalize({
                    interpreter: make_object_interpreter(user_intrp, _settings.checkArity),
                    completion: (0, _keys2.default)(user_intrp)
                });
            } else {
                // allow $('<div/>').terminal();
                if (type === 'undefined') {
        ...
        function make_json_rpc_login(url, login) {
            ...
            return function (user, passwd, callback) {
                ...
                $.jrpc({
                    ...
                    method: method,
                    params: [user, passwd],
                    request: function request(jxhr, _request3) {
                        try {
                            _settings.request.call(self, jxhr, _request3, self);
                        } catch (e) {
                            display_exception(e, 'USER');
                        }
                    },
                    response: function response(jxhr, _response3) {
                        try {
                            _settings.response.call(self, jxhr, _response3, self);
                        } catch (e) {
                            display_exception(e, 'USER');
                        }
                    },
        ...
        function display_exception(e, label) {
            if ($.isFunction(_settings.exceptionHandler)) {
        ...
        function buffer_line(string, options) {
            ...
            if (_settings.convertLinks && !options.raw) {
                ...
                if (options.formatters) {
                    ...
                    for (i = 0; i < formatters.length; ++i) {
                        try {
                            ...
                            if ($.isFunction(_settings.exceptionHandler)) {
                                _settings.exceptionHandler.call(self, e, 'FORMATTERS');
                            } else {
                                alert('formatting error at formatters[' + i + ']\n' + (e.stack ? e.stack : e));
                            }
                        }
        ...
        function show_greetings() {
            if (_settings.greetings === undefined) {
                ...
                var type = (0, _typeof3.default)(_settings.greetings);
                if (type === 'string') {
                    self.echo(_settings.greetings);
                } else if (type === 'function') {
                    _settings.greetings.call(self, self.echo);
                } else {
        ...
        function echo_command(command) {
            ...
            console.log(command);
            switch (typeof mask === 'undefined' ? 'undefined' : (0, _typeof3.default)(mask)) {
                case 'string':
        ...
        function maybe_update_hash() {
            if (change_hash) {
                ...
                location.hash = '#' + (0, _stringify2.default)(hash_commands);
                setTimeout(function () {
        ...
        function commands(command, silent, exec) {
            ...
            function after_exec() {
                ...
                deferred.resolve();
                if ($.isFunction(_settings.onAfterCommand)) {
                    _settings.onAfterCommand.call(self, self, command);
                }
            }
            try {
                // this callback can disable commands
                if ($.isFunction(_settings.onBeforeCommand)) {
                    if (_settings.onBeforeCommand.call(self, self, command) === false) {
                        return;
                    }
                }
                if (!exec) {
                ...
                if (!ghost()) {
                    ...
                    if (exec && ($.isFunction(_settings.historyFilter) && _settings.historyFilter(command) || command.match(_settings.historyFilter))) {
        ...
        function global_logout() {
            if ($.isFunction(_settings.onBeforeLogout)) {
                try {
                    if (_settings.onBeforeLogout.call(self, self) === false) {
                        return;
                    }
                } catch (e) {
            ...
            if ($.isFunction(_settings.onAfterLogout)) {
                try {
                    _settings.onAfterLogout.call(self, self);
                } catch (e) {
                    display_exception(e, 'onAfterlogout');
                }
            }
            self.login(_settings.login, true, initialize);
        }
        // ---------------------------------------------------------------------
        ...
        function maybe_append_name(interpreter_name) {
            ...
            if ($.inArray(interpreter_name, names) === -1) {
                ...
                storage.set(storage_key, (0, _stringify2.default)(names));
            }
        }
        // ---------------------------------------------------------------------
        ...
        function initialize() {
            ...
            if ($.isFunction(_settings.onInit)) {
        ...
        function user_key_down(e) {
            ...
            } else if ($.isFunction(_settings.keydown)) {
        ...
        var keymap = {
            'CTRL+D': function CTRLD(e, original) {
                if (!in_login) {
                    if (command_line.get() === '') {
                        if (interpreters.size() > 1 || _settings.login !== undefined) {
                            self.pop('');
                        } else {
                            self.resume();
                            self.echo('');
            ...
            'TAB': function TAB(e, orignal) {
                ...
                var top = interpreters.top(),
                    completion;
                if (_settings.completion && $.type(_settings.completion) !== 'boolean' && top.completion === undefined) {
                    completion = _settings.completion;
                } else {
        ...
        var _settings = $.extend({}, $.terminal.defaults, { name: self.selector }, options || {});
        var storage = new StorageHelper(_settings.memory);
        var strings = $.extend({}, $.terminal.defaults.strings, _settings.strings);
        ...
        $.extend(self, $.omap({
            ...
            clear: function clear() {
                ...
                lines = [];
                try {
                    _settings.onClear.call(self, self);
                } catch (e) {
            ...
            export_view: function export_view() {
                var user_export = {};
                if ($.isFunction(_settings.onExport)) {
                    try {
                        user_export = _settings.onExport.call(self);
                    } catch (e) {
            ...
            import_view: function import_view(view) {
                ...
                if ($.isFunction(_settings.onImport)) {
                    try {
                        _settings.onImport.call(self, view);
                    } catch (e) {
            ...
            pause: function pause(visible) {
                cmd_ready(function ready() {
                    ...
                    if ($.isFunction(_settings.onPause)) {
                        _settings.onPause.call(self);
                    }
                });
                return self;
            },
            ...
            resume: function resume() {
                cmd_ready(function ready() {
                    ...
                    scroll_to_bottom();
                    if ($.isFunction(_settings.onResume)) {
                        _settings.onResume.call(self);
                    }
                });
                return self;
            },
            ...
            // -------------------------------------------------------------
            cols: function cols() {
                return _settings.numChars ? _settings.numChars : get_num_chars(self);
            },
            // -------------------------------------------------------------
            ...
            // -------------------------------------------------------------
            rows: function rows() {
                return _settings.numRows ? _settings.numRows : get_num_rows(self);
            },
            // -------------------------------------------------------------
            ...
            next: function next() {
                if (terminals.length() === 1) {
                    ...
                    */
                    ...
                    try {
                        _settings.onTerminalChange.call(next, next);
                    } catch (e) {
            ...
            focus: function focus(toggle, silent) {
                cmd_ready(function ready() {
                    ...
                    if (terminals.length() === 1) {
                        if (toggle === false) {
                            try {
                                ret = _settings.onBlur.call(self, self);
                            ...
                            try {
                                ret = _settings.onFocus.call(self, self);
                                if (!silent && ret !== false || silent) {
                                    self.enable();
                                }
                            } catch (e) {
                        ...
                        if (front !== self) {
                            ...
                            if (!silent) {
                                try {
                                    _settings.onTerminalChange.call(self, self);
                                } catch (e) {
                                    display_exception(e, 'onTerminalChange');
                                }
                            }
            ...
            // -------------------------------------------------------------
            set_command: function set_command(command) {
                when_ready(function ready() {
                ...
                if (!self.is(':visible')) {
                    ...
                    if (new_num_chars !== num_chars || new_num_rows !== num_rows) {
                        ...
                        if ($.isFunction(top.resize)) {
                            top.resize(self);
                        } else if ($.isFunction(_settings.onResize)) {
                            _settings.onResize.call(self, self);
                        }
                        scroll_to_bottom();
                    }
                }
            ...
            flush: function flush() {
                try {
                    ...
                    if ($.isFunction(_settings.exceptionHandler)) {
                        _settings.exceptionHandler.call(self, e, 'TERMINAL (Flush)');
                    } else {
            ...
            // -------------------------------------------------------------
            update: function update(line, string) {
                when_ready(function ready() {
                    if (line < 0) {
            ...
            // -------------------------------------------------------------
            echo: function echo(string, options) {
            ...
            // -------------------------------------------------------------
            read: function read(message, callback) {
                var d = new $.Deferred();
            ...
            push: function push(interpreter, options) {
                cmd_ready(function ready() {
                    ...
                    function init() {
                        _settings.onPush.call(self, top, interpreters.top(), self);
                        prepare_top_interpreter();
                    }
                    // self.pause();
            ...
            pop: function pop(string, silent) {
                ...
                if (interpreters.size() === 1) {
                    ...
                    if (_settings.login) {
                        global_logout();
                        if ($.isFunction(_settings.onExit)) {
                            try {
                                _settings.onExit.call(self, self);
                            } catch (e) {
                    ...
                    if (!silent) {
                        _settings.onPop.call(self, top, null, self);
                    }
                } else {
                    if (token) {
                        clear_loging_storage();
                    ...
                    prepare_top_interpreter();
                    if (!silent) {
                        _settings.onPop.call(self, current, top);
                    }
            ...
            option: function option(object_or_name, value) {
                if (typeof value === 'undefined') {
                    ...
                    } else if ((typeof object_or_name === 'undefined' ? 'undefined' : (0, _typeof3.default)(object_or_name)) === 'object') {
        ...
        // before login event
        if (_settings.login && $.isFunction(_settings.onBeforeLogin)) {
            try {
                if (_settings.onBeforeLogin.call(self, self) === false) {
                    autologin = false;
                }
            } catch (e) {
        ...
        if (base_interpreter && (typeof _settings.login === 'string' || _settings.login === true)) {
            _settings.login = make_json_rpc_login(base_interpreter, _settings.login);
        }
        ...
        make_interpreter(init_interpreter, !!_settings.login, function (itrp) {
            ...
            var new_keymap = $.extend({}, keymap, _settings.keymap || {});
            ...
            command_line = $('<div/>').appendTo(wrapper).cmd({
                ...
                keypress: function keypress(e) {
                    ...
                    } else if ($.isFunction(_settings.keypress)) {
                        return _settings.keypress.call(self, e, self);
                    }
                },
                onCommandChange: function onCommandChange(command) {
                    if ($.isFunction(_settings.onCommandChange)) {
                        try {
                            _settings.onCommandChange.call(self, command, self);
                        } catch (e) {
            ...
            if (_enabled2 && self.is(':visible') && !is_touch) {
            ...
            self.oneTime(100, function () {
                function disable(e) {
                    var sender = $(e.target);
                    if (!sender.closest('.terminal').length && self.enabled() && _settings.onBlur.call(self, self) !== false) {
                        self.disable();
                    }
                }
                        ...
                        if (!wasDragging) {
                            if (++count === 1) {
                                if (!self.enabled() && !_frozen) {
                                    ...
                                    self.oneTime(_settings.clickTimeout, name, function () {
                                        // move cursor to the end if clicked after .cmd
                                        if (!target.is('.terminal-output') && !target.is('.cmd') && target.is('.terminal > div')) {
            ...
            if ($.event.special.mousewheel) {
                ...
                self.mousewheel(function (event, delta) {
                    if (!shift) {
                        ...
                        } else if ($.isFunction(_settings.mousewheel)) {
